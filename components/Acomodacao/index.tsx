  ...
  return (
    <div>
        <figure className="relative">
            <div className="flex w-full justify-between items-center absolute pt-3 px-2 font-semibold">
                <span className="bg-white rounded-full px-2 py-1 text-sm">Preferido dos Hóspedes</span>
                <IconHeartFilled className="stroke-white hover:fill-gray-600 hover:scale-110" aria-label="ícone de Favoritos" size={25} color="black"/>
            </div>
            {children}
